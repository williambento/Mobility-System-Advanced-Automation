...
implements StepAdvanceListener
{
	...
	VehicleType (
		...
		addReadQuery(Variable.LENGTH, 
				new ReadObjectVarQuery.DoubleQ (dis, dos,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_VEHICLETYPE_VARIABLE
	, 
				id,
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_ACCEL
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_DECEL
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_MINGAP
		...
		, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_SET_VEHICLETYPE_VARIABLE
