...
implements StepAdvanceListener
{
	...
	Vehicle (
		...
		addReadQuery(Variable.SPEED, 
				new ReadObjectVarQuery.DoubleQ (dis, dos,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_VEHICLE_VARIABLE
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_SPEED
	...
	, 
				id,
					sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_LANEPOSITION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_LANE_INDEX
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_ROAD_ID
				, repoEdge
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_CO2EMISSION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_COEMISSION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_HCEMISSION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_PMXEMISSION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_NOXEMISSION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_FUELCONSUMPTION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_NOISEEMISSION
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_COLOR
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_TYPE
		...
		{
			@Override
			void pickResponses(java.util.Iterator<sim.traci4j.src.java.it.polito.appeal.traci.protocol.ResponseContainer> responseIterator)
		...
		, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_SET_VEHICLE_VARIABLE
		...
		, id
		, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_LANE_CHANGE_MODE
			)
		;
