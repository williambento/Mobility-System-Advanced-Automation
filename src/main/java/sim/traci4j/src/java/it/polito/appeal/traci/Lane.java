...
implements StepAdvanceListener
{
	...
	Lane (
		...
		addReadQuery(Variable.SHAPE, 
				new ReadShapeQuery (dis, dos,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_LANE_VARIABLE
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_SHAPE
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_WIDTH
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LAST_STEP_OCCUPANCY
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_MAXSPEED
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LANE_EDGE_ID
				, repoEdge
	...
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LANE_LINKS
				, repoLane
