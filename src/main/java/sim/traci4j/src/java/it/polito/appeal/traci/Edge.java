	...
	Edge (
		...
		addReadQuery(Variable.TRAVEL_TIME, 
				new ReadGlobalTravelTimeQuery (dis, dos,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_EDGE_VARIABLE
	, 
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_EDGE_TRAVELTIME
